...
### Gigs API
- `GET /api/gig` - Get all gigs with optional filtering
- `GET /api/gig/:id` - Get gig by ID
- `POST /api/gig` - Create new gig
- `PUT /api/gig/:id` - Update gig
- `DELETE /api/gig/:id` - Delete gig
- `POST /api/gig/:id/msg` - Add message to gig
